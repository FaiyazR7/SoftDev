"""
TEAM BLUE TIRAMISU: Shreya Roy, Eric Sohel, Faiyaz Rafee
SoftDev
09/23/2022
DISCO:
 - You have to import random before using it..
QCC:
OPS SUMMARY:
We made a list of the keys and used random choice to choose a
random period, and we used the length of that period's list
to choose a random DEVO.
"""
import random
krewes = {
...
mylist = [2,7, 8]
temp = krewes[random.choice(mylist)]
val = random.randrange(1, len(temp), 1)
