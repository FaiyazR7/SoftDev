...
def hello_world():
    ...
    return f'Dual Ducks: Brian Yang, Donald Bi, Faiyaz Rafee <br> SoftDev <br> K08 --Flask <br> 2022-10-06 <br> time spent:1hr<br> <br>{csv_to_dictionary()[0]} <br> <br> {get_random_occupation()}'
